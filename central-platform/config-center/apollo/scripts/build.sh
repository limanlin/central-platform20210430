...
apollo_config_db_url=jdbc:mysql://localhost:3366/ApolloConfigDB?characterEncoding=utf8
apollo_config_db_username=root
apollo_config_db_password=

# apollo portal db info
apollo_portal_db_url=jdbc:mysql://localhost:3366/ApolloPortalDB?characterEncoding=utf8
